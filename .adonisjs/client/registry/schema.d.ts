...
export interface Registry {
  ...
  'transactions.purchase': {
    ...
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/transaction').purchaseValidator)>>
      paramsTuple: []
      params: {}
      query: ExtractQuery<InferInput<(typeof import('#validators/transaction').purchaseValidator)>>
