...
const routes = {
  ...
  'transactions.purchase': {
    methods: ["POST"],
    pattern: '/api/v1/transactions/purchase',
    tokens: [{"old":"/api/v1/transactions/purchase","type":0,"val":"api","end":""},{"old":"/api/v1/transactions/purchase","type":0,"val":"v1","end":""},{"old":"/api/v1/transactions/purchase","type":0,"val":"transactions","end":""},{"old":"/api/v1/transactions/purchase","type":0,"val":"purchase","end":""}],
